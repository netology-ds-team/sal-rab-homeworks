function addInCartMessage(name, price) {
    let productName = name;
    let productPrice = price;

    // Задача №1.1. Оповещение о добавлении в корзину
...
function addInCartCountChange(value) {
    ...
    // замените все переменные, которым значения присваиваются единожды, на константы

    // Конец решения задачи №1.2.
...
function addInCartSumChange(sum, delta) {
    ...
    // Задача №1.3. Увеличение суммы в корзине
